...
const C = {
  panel:        Color4.create(0.05, 0.07, 0.13, 0.97),
  headerBg:     Color4.create(0.08, 0.11, 0.20, 1),
  separator:    Color4.create(0.14, 0.18, 0.32, 1),

  rowLabel:     Color4.create(0.06, 0.14, 0.28, 1),
  rowLabelText: Color4.create(0.52, 0.82, 1.00, 1),

  cardT1:       Color4.create(0.10, 0.20, 0.42, 1),
  cardT1Sel:    Color4.create(0.18, 0.38, 0.75, 1),
  cardT2:       Color4.create(0.22, 0.09, 0.42, 1),
  cardT2Sel:    Color4.create(0.40, 0.16, 0.78, 1),
  cardT3:       Color4.create(0.35, 0.20, 0.04, 1),
  cardT3Sel:    Color4.create(0.62, 0.36, 0.05, 1),
  cardOwned:    Color4.create(0.07, 0.24, 0.14, 1),
  cardOwnedSel: Color4.create(0.10, 0.40, 0.22, 1),

  detailBg:     Color4.create(0.07, 0.09, 0.16, 1),
  statRowA:     Color4.create(0.11, 0.14, 0.24, 1),
  statBarBg:    Color4.create(0.16, 0.20, 0.34, 1),
  statBarFg:    Color4.create(0.28, 0.62, 1.00, 1),

  textWhite:    Color4.create(1.00, 1.00, 1.00, 1),
  textGold:     Color4.create(1.00, 0.82, 0.20, 1),
  textGray:     Color4.create(0.58, 0.66, 0.80, 1),
  textGreen:    Color4.create(0.28, 0.94, 0.58, 1),
  textLocked:   Color4.create(0.36, 0.40, 0.55, 1),
  textTitle:    Color4.create(0.85, 0.90, 1.00, 1),

  tierT1:       Color4.create(0.48, 0.76, 1.00, 1),
  tierT2:       Color4.create(0.80, 0.48, 1.00, 1),
  tierT3:       Color4.create(1.00, 0.78, 0.12, 1),

  btnBuy:       Color4.create(0.12, 0.55, 0.90, 1),
  btnEquip:     Color4.create(0.10, 0.65, 0.38, 1),
  btnEquipped:  Color4.create(0.07, 0.22, 0.13, 1),
  btnLocked:    Color4.create(0.10, 0.12, 0.20, 1),
  btnClose:     Color4.create(0.72, 0.12, 0.10, 1),
  goldBadgeBg:  Color4.create(0.22, 0.15, 0.03, 1),
